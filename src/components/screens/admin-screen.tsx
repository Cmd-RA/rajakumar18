...
import { ShieldAlert, Trash2, Ban, Users, MessageSquare, ExternalLink, Video, Save, Send, Bell } from 'lucide-react';
            ...
            <TabsContent value="notifications" className="space-y-6">
              <Card className="rounded-2xl border-border overflow-hidden">
                <CardHeader className="bg-accent/5">
                  ...
                  <CardDescription>Send updates to all active users</CardDescription>
                </CardHeader>
                <CardContent className="p-6 space-y-4">
                  <div className="space-y-4">
                    <textarea 
                      className="w-full bg-muted border-none rounded-xl p-4 text-sm focus:ring-1 focus:ring-accent resize-none h-32"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <Button onClick={handleSendNotification} className="rounded-xl bg-primary">
                        <Send className="w-4 h-4 mr-2" /> Push to App
                      </Button>
